...
class Calibrator{
    ...
    public:
        ...
        bool doBA(std::shared_ptr<FrameData> currframe, bool nosolve = false);
        void filter_outof_FOV(std::shared_ptr<FrameData> frame);
    ...
    private:
        ...
        deque<std::shared_ptr<FrameData>> m_deque_shortterm_BAed_framedata;
        ...
        PclVisualizerWrapper m_pclviewer;

        //GtsamSLAM m_gtsamSLAM;
};
